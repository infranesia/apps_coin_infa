...
<body class="index-page">
  ...
  <nav class="navbar navbar-expand-lg fixed-top navbar-transparent ">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="https://coin.infranesia.com" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
          <img src="./assets/img/infa/logo-small.png" width="15%"><span> Infa</span>Coin
        </a>
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navigation">
        ...
        <ul class="navbar-nav">
          <li class="nav-item p-0">
            <a class="nav-link" rel="tooltip" title="Follow us on Twitter" data-placement="bottom" href="https://twitter.com/halo_infranesia" target="_blank">
              <i class="fab fa-twitter"></i>
              <p class="d-lg-none d-xl-none">Twitter</p>
            </a>
          </li>
          <li class="nav-item p-0">
            <a class="nav-link" rel="tooltip" title="Like us on Facebook" data-placement="bottom" href="https://www.facebook.com/infranesia_official" target="_blank">
              <i class="fab fa-facebook-square"></i>
              <p class="d-lg-none d-xl-none">Facebook</p>
            </a>
          </li>
          <li class="nav-item p-0">
            <a class="nav-link" rel="tooltip" title="Follow us on Instagram" data-placement="bottom" href="https://www.instagram.com/infranesia_official" target="_blank">
          ...
          <li class="dropdown nav-item">
            ...
            <div class="dropdown-menu dropdown-with-icons">
              ...
              <a href="https://infranesia.com" class="dropdown-item">
                <i class="tim-icons icon-image-02"></i>Infranesia.com
              </a>
            </div>
          </li>
          <li class="nav-item">
          ...
          <div class="container">
            ...
            <div class="blur-hover">
              <a href="https://solscan.io/token/EpKFYk3mCtoWT11itNswZgdGy7SQyvRhRJKpkFetxixj">
                ...
                <span class="blur-hidden h5 text-primary">Explore InfaCoin</span>
              </a>
            </div>
          </div>
        </div>
  ...
  <!-- Black Dashboard INFA methods, don't include it in your project! -->
  <script src="./assets/infa/infa.js"></script>
